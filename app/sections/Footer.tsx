            ...
            <div className="flex flex-wrap gap-3 mt-5">
              {[
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center rounded-[10px] bg-[#12121a] border border-[rgba(148,163,184,0.06)] p-2.5 no-underline transition-all hover:bg-[#1a1a24] hover:border-[rgba(99,102,241,0.2)]"
                  aria-label={`Follow Zakaa on ${item.name}`}
