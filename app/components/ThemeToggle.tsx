...
export default function ThemeToggle({ locale = "en" }: Readonly<ThemeToggleProps>) {
  ...
  return (
    <button
      ...
      className="zakaa-navbar-control inline-flex items-center gap-2 rounded-[10px] border border-[rgba(148,163,184,0.12)] bg-transparent px-4 py-2.5 text-sm font-semibold text-[#94A3B8] transition-all hover:bg-[#1E293B] hover:text-[#F8FAFC]"
    >
