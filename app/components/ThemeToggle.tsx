...
export default function ThemeToggle({ locale = "en" }: Readonly<ThemeToggleProps>) {
  ...
  return (
    <button
      ...
      className="zakaa-navbar-control inline-flex items-center gap-2 rounded-[10px] border border-[rgba(148,163,184,0.1)] bg-transparent px-4 py-2.5 text-sm font-semibold text-[#a1a1aa] transition-all hover:bg-[#1a1a24] hover:text-[#e4e4e7]"
    >
